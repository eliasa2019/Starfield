...
class NormalParticle implements Particle {
  protected float x, y, speed, angle;
  protected color c;
  ...
  public void show() {
    fill(c);
    // The size of the particle is dependent on its speed, which furthers the three-dimensional illusion
    rect(this.x, this.y, this.speed / 3, this.speed / 3);
  }
...
class JumboParticle extends NormalParticle {
  ...
  public void show() {
    fill(this.c);
    rect(this.x, this.y, 2 * this.speed, 2 * this.speed);
  }
}
interface Particle {
  public void move();
